...
LlmAdapter::generateDescription(const Port::Out::GameStateDTO &game_state, const Domain::Event::DomainEvent& event) {
  ...
  spdlog::info("AI Adapter: Generating description for player at ({}, {}) for event: {}",
  ...
  std::string prompt =
      ...
      "당신은 던전 마스터입니다. 다음 게임 상태 정보와 발생한 이벤트를 바탕으로 플레이어 주변 "
