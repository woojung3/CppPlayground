        ...
        namespace Out {
            namespace Persistence {
                ...
                public:
                    ...
                    void saveForBatch(const std::string& key, const Domain::Model::Player& player);
                ...
                private:
                    ...
                    StandardLayoutCrudRepository<Domain::Model::PlayerCoreStats> player_core_stats_crud_;
