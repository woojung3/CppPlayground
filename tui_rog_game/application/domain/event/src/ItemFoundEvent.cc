...
static_assert(std::is_same_v<
              ...
              "Underlying types of ItemFoundEvent::ItemType and Domain::Model::Item::ItemType mismatch");

static_assert(static_cast<int>(ItemFoundEvent::ItemType::HealthPotion) == static_cast<int>(TuiRogGame::Domain::Model::Item::ItemType::HealthPotion),
              "ItemFoundEvent::ItemType::HealthPotion value mismatch");
static_assert(static_cast<int>(ItemFoundEvent::ItemType::StrengthScroll) == static_cast<int>(TuiRogGame::Domain::Model::Item::ItemType::StrengthScroll),
              "ItemFoundEvent::ItemType::StrengthScroll value mismatch");
// Add more static_asserts here if more ItemType enumerators are added in the future.

ItemFoundEvent::ItemFoundEvent(
    ItemType item_type,
