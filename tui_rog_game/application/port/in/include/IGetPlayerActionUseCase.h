...
namespace TuiRogGame {
    namespace Port {
        namespace In {
            ...
            // IGetPlayerActionUseCase is an inbound port interface that defines the use case
            // for handling player actions. The GameEngine will implement this interface.
            // As per HexBook.md Chapter 3 and 5, inbound ports represent use cases
            // and are typically named with a 'UseCase' suffix.
